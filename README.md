...
It runs using node.js. It heavily leverages [forever.js](https://github.com/nodejitsu/forever-monitor) for process management. Bowie applications in theory be programmed in any language. 
